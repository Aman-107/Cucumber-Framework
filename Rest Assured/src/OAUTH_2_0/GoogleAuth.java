...
*/
		...
		String url ="https://rahulshettyacademy.com/getCourse.php?code=4%2F0AanRRrvArDYfiOM-U8EsduEqHM6a12q0gyMPF373_KOFmCyEtziF7RHBH9sC08p9k9Yavw&scope=email+openid+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email&authuser=0&prompt=consent";
		String code = url.split("code=")[1].split("&")[0].trim();
		System.out.println(code);
		
		//Get Access Token
	 String acessTokenResponse =given().urlEncodingEnabled(false)
